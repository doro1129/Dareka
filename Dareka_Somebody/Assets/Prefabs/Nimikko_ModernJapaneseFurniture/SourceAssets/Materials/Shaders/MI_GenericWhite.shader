		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.796875,0.796875,0.796875,1.000000);//Colour
	Material.VectorExpressions[3] = float4(0.796875,0.796875,0.796875,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,0.700000,0.000000);//(Unknown) Metalness Roughness (Unknown)
