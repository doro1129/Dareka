Shader "Unreal/MI_Wood_Painted_White"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Masks", 2D ) = "white" {}
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.770833,0.770833,0.770833,1.000000);//Tint
	Material.VectorExpressions[3] = float4(0.770833,0.770833,0.770833,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(4.000000,0.000000,0.000000,1.000000);//Tiling Normal Flatness (Unknown) Roughness
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local4 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local5 = (Local4.g * Material.ScalarExpressions[0].w);
	...
	PixelMaterialInputs.Roughness = Local5;
