		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,1.489004,0.050000);//(Unknown) Power Reflection Side Reflection Front
	Material.ScalarExpressions[1] = float4(0.000000,0.038095,0.005000,1.000000);//Roughness Opacity Side Opacity Front Refraction Side
