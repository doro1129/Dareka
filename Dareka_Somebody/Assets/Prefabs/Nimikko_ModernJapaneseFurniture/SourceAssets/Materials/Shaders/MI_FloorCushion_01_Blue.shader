Shader "Unreal/MI_FloorCushion_01_Blue"
{
	Properties
	{
		...
		Material_Texture2D_2( "AORM", 2D ) = "white" {}
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.331221,0.413763,1.000000,1.000000);//Tint
	Material.VectorExpressions[3] = float4(0.331221,0.413763,1.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,0.000000);//Normal Strength (Unknown) (Unknown) Hue Shift
	Material.ScalarExpressions[1] = float4(0.000000,2.000000,0.000000,1.000000);//(Unknown) Brightness Saturation Roughness
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local1 = lerp(Local0.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),MaterialFloat(Material.ScalarExpressions[0].y));

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = Local1;
	...
	MaterialFloat3 Local2 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[1].rgb,MaterialFloat(Material.ScalarExpressions[0].z));
	MaterialFloat4 Local3 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat3 Local4 = (Local3.rgb * Material.ScalarExpressions[1].y);
	MaterialFloat3 Local5 = (Material.VectorExpressions[3].rgb * Local4);
	MaterialFloat3 Local6 = RotateAboutAxis(MaterialFloat4((MaterialFloat3(1.00000000,1.00000000,1.00000000) / sqrt(dot(MaterialFloat3(1.00000000,1.00000000,1.00000000),MaterialFloat3(1.00000000,1.00000000,1.00000000)))),Material.ScalarExpressions[1].x),MaterialFloat3(0.00000000,0.00000000,0.00000000),Local5);
	MaterialFloat3 Local7 = (Local6 + Local5);
	MaterialFloat Local8 = dot(Local7, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local9 = lerp(Local7,MaterialFloat3(Local8,Local8,Local8),MaterialFloat(Material.ScalarExpressions[1].z));
	MaterialFloat4 Local10 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local11 = (Local10.g * Material.ScalarExpressions[1].w);
