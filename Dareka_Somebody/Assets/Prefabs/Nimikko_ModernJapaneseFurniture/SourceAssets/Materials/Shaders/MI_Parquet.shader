		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,1.000000);//Tiling Normal Flatness (Unknown) Brightness
	Material.ScalarExpressions[1] = float4(0.000000,4.000000,0.000000,0.000000);//Metalness Roughness (Unknown) (Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local8 = (Material.ScalarExpressions[1].y * Local7.rgb);

	PixelMaterialInputs.EmissiveColor = Local3;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local6;
	PixelMaterialInputs.Metallic = Material.ScalarExpressions[1].x;
