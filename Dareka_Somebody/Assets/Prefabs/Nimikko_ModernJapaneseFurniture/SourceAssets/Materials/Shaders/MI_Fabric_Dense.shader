		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(1.000000,0.581628,0.305122,1.000000);//Tint
	Material.VectorExpressions[3] = float4(1.000000,0.581628,0.305122,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(8.000000,0.000000,0.000000,1.000000);//Tiling Normal Flatness (Unknown) Brightness
