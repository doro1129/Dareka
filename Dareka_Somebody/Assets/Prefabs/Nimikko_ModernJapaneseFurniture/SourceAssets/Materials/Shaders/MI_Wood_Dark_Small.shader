Shader "Unreal/MI_Wood_Dark_Small"
{
	Properties
	{
		...
		Material_Texture2D_2( "Masks", 2D ) = "white" {}
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.395833,0.267763,0.263824,1.000000);//Tint
	Material.VectorExpressions[3] = float4(0.395833,0.267763,0.263824,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(2.000000,0.000000,0.000000,1.000000);//Tiling Normal Flatness (Unknown) Brightness
	Material.ScalarExpressions[1] = float4(1.500000,0.000000,0.000000,0.000000);//Roughness (Unknown) (Unknown) (Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local2 = lerp(Local1.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),MaterialFloat(Material.ScalarExpressions[0].y));

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = Local2;
	...
	MaterialFloat3 Local3 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[1].rgb,MaterialFloat(Material.ScalarExpressions[0].z));
	MaterialFloat4 Local4 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat3 Local5 = (Local4.rgb * Material.ScalarExpressions[0].w);
	MaterialFloat3 Local6 = (Material.VectorExpressions[3].rgb * Local5);
	MaterialFloat4 Local7 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local8 = (Local7.g * Material.ScalarExpressions[1].x);

	PixelMaterialInputs.EmissiveColor = Local3;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local6;
	PixelMaterialInputs.Metallic = Local7.b;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local8;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local7.r;
