		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.780000,1.000000,1.000000,1.000000);//Color
	Material.VectorExpressions[3] = float4(0.780000,1.000000,1.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,0.681912,0.050000);//(Unknown) Power Reflection Side Reflection Front
	Material.ScalarExpressions[1] = float4(0.000000,0.352381,0.005000,1.000000);//Roughness Opacity Side Opacity Front Refraction Side
	Material.ScalarExpressions[2] = float4(1.200000,0.000000,0.000000,0.000000);//Refraction Front RefractionDepthBias (Unknown) (Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local1 = dot(Parameters.TangentToWorld[2], Parameters.CameraVector);
	MaterialFloat Local2 = min(max(Local1,0.00000000),1.00000000);
	MaterialFloat Local3 = (1.00000000 - Local2);
	MaterialFloat Local4 = PositiveClampedPow(Local3,Material.ScalarExpressions[0].y);
	MaterialFloat Local5 = lerp(Material.ScalarExpressions[0].w,Material.ScalarExpressions[0].z,Local4);
	MaterialFloat Local6 = lerp(Material.ScalarExpressions[1].z,Material.ScalarExpressions[1].y,Local4);
	MaterialFloat Local7 = lerp(Material.ScalarExpressions[2].x,Material.ScalarExpressions[1].w,Local4);
	...
	PixelMaterialInputs.Metallic = Local5;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Material.ScalarExpressions[1].x;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = 1.00000000;
	PixelMaterialInputs.Refraction = MaterialFloat2(Local7,Material.ScalarExpressions[2].y);
